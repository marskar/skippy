...
pickle_model(filename='digits_logistic.pickle', model=fit)
predictions = fit.predict(x_test)
accuracy = accuracy_score(y_test, predictions)
confmat = confusion_matrix(y_test, predictions)
plot_cm(cm=confmat, filename='digits_confusion_matrix.images', acc=accuracy)
